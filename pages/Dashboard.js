...
const Dashboard = ({ address }) => {
    ...
    useEffect(() => {
        const getSanityAndThirdWebTokens = async () => {
            ...
            const coins = await fetch("https://5e4mdjzc.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type%3D%3D'coins'%5D%7B%0A%20%20name%2C%0A%20%20usdPrice%2C%0A%20%20contractAddress%2C%0A%20%20symbol%2C%0A%20%20logo%2C%0A%7D")
